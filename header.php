...
<div class="container">
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="index.php">Xingo Shop</a>
  </div>
        ...
        <li><a href = "cart.php"><span class = "glyphicon glyphicon-shopping-cart"></span>Cart</a></li>
         ...
         ?>
          <?php
                ...
                else if(isset($_SESSION['email1'])){
                  ?>
          <li><a href = "menu.php"><span class = "glyphicon glyphicon-shopping-cart"></span>Menu</a></li>
         <li><a href = "setting.php"><span class = "glyphicon glyphicon-user"></span> Settings</a></li>
         <li><a href = "logout_script.php"><span class = "glyphicon glyphicon-log-out"></span> Logout</a></li>
